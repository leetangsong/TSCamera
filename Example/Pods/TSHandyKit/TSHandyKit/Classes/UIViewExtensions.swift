...
extension UIView: TSKitCompatible{}
extension UIView: TSKitClassCompatible{ }

extension TSKitWrapper where Base: UIView {
    ...
    public var right: CGFloat{
        get{
            ...
            return base.superview!.ts.width - base.ts.maxX
        }
        set{
            assert(base.superview != nil, "未添加到父视图上")
            var frame = base.frame
            frame.origin.x += base.superview!.ts.width - newValue - base.ts.width
            base.frame = frame
        }
    }
...
extension TSKitClassWrapper where Base == UIView {
